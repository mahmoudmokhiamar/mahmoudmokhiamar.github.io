    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          title: 'Completed research assistantship at Knowledge and Data Engineering Lab',
          description: "",
          section: "News",},{id: "news-excited-to-launch-my-new-academic-portfolio-here-you-ll-find-my-research-experiences-projects-publications-and-technical-skills-in-data-science-machine-learning-and-ai-feel-free-to-explore-connect-and-collaborate-computerscience-ai-machinelearning-datascience",
          title: '🚀 Excited to launch my new academic portfolio! Here you’ll find my research...',
          description: "",
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-sparse-supervision-for-remote-sensing-segmentation",
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-knowledge-graphs-using-llms",
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-eeg-sleep-stage-classification",
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-sentence-highlighter-with-bert-embeddings",
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-cloud-deployment-project",
          title: 'Cloud Deployment Project',
          description: "Full-stack cloud deployment using Docker, Kubernetes, and Nginx.",
          section: "Projects",handler: () => {
              window.location.href = "/projects/7_project/";
            },},{id: "projects-alzheimer-xai-explainable-ai-for-dementia-stage-classification",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6D%61%68%6D%6F%75%64%6D%6F%6B%68%69%61%6D%61%72@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/mahmoudmokhiamar", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/mahmoud-mokhiamar", "_blank");
        },
      },{
        id: 'social-whatsapp',
        title: 'whatsapp',
        section: 'Socials',
        handler: () => {
          window.open("https://wa.me/201029449370", "_blank");
        },
      },{
      id: 'light-theme',
